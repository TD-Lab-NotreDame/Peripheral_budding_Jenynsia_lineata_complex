...
data="/afs/crc.nd.edu/user/r/rberg4/analysis/denovo/Jenynsia_rad_denovo_in_obscura_mac3_filtered_final_LD_pruned.snps.hdf5"
...
axes = canvas.cartesian(grid=(3, 3, 1))
tmx.draw_tree(axes)

toyplot.pdf.render(canvas, "treemix-m1_1.pdf")